...
\begin{document}
	...
	Parte dos eventos descritos ao longo do capítulo encontram-se sumarizados na figura \ref*{fig:cronologia}. Adicionalmente, no tocante à ocupação dos mananciais, \citeonline{Matsunaga2015} elaborou uma linha do tempo que visa ``elucidar o processo nas diversas escalas'' \cite[p.37]{Matsunaga2015}, conforme podemos ver na figura \ref*{fig:matsunaga_linha}.
